...
router.put('/projects/:id/status', authenticateToken, projectController.changeProjectStatus);
router.put('/projects/:projectId/tasks/:taskId/status', authenticateToken, projectController.changeTaskStatus);
